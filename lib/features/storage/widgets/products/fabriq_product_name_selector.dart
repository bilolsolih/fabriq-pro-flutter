...
class FabriqProductNameSelector extends StatefulWidget {
  const FabriqProductNameSelector({super.key, required this.productNames, required this.title,});
...
class _FabriqProductNameSelectorState extends State<FabriqProductNameSelector> {
  ...
  void initState() {
    super.initState();
    selectedValue = widget.productNames.isNotEmpty ? widget.productNames[0] : '';
  }
    ...
    return Column(
      ...
      children: [
        ...
        DropdownMenu<String>(
          ...
          menuHeight: 200,
          dropdownMenuEntries: widget.productNames.map(
